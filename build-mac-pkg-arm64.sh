...
sips -z 128 128 "$ICON_SOURCE" --out "$TEMP_BUILD_DIR/resources.iconset/icon_128x128.png"
iconutil -c icns "$TEMP_BUILD_DIR/resources.iconset" -o "$ICON_ICNS"

# === Copy background image to proper resources folder ===
mkdir -p "$TEMP_BUILD_DIR/resources"
#sips -z 500 500 resources/installer_bg.png --out build/resources/installer_bg.png
convert resources/shibudb.png \
  -strip \
  -profile /System/Library/ColorSync/Profiles/sRGB\ Profile.icc \
  "$TEMP_BUILD_DIR/resources/installer_bg.png"
