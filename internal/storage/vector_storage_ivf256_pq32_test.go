...
func TestVectorEngineImpl_InsertAndSearch_IVF256PQ32(t *testing.T) {
	dataPath := "testdata/vector_data_ivf256_pq32.db"
	indexPath := "testdata/vector_index_ivf256_pq32.faiss"
	walPath := "testdata/vector_wal_ivf256_pq32.db"
	maxVectorSize := 1024
	indexDesc := "IVF256,PQ32"
