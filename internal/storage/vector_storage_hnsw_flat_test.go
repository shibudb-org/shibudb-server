...
func TestVectorEngineImpl_InsertAndSearch_HNSW32Flat(t *testing.T) {
	...
	t.Run("Remove vector", func(t *testing.T) {
		...
		cleanWalPath := "testdata/vector_wal_hnsw_remove.db"
	...
	t.Run("Remove non-existent vector", func(t *testing.T) {
		...
		cleanWalPath := "testdata/vector_wal_hnsw_remove_nonexistent.db"
